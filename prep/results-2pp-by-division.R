...
#
# Peter Ellis 3 March 2019

# Updated by Ryan Batchelor
...
config <- data.frame(
  url =c("https://results.aec.gov.au/27966/Website/Downloads/HouseTppByDivisionDownload-27966.csv",
  ...
  election_date = as.Date(c("2022-05-21", "2019-05-18", "2016-07-02", "2013-09-07", "2010-08-21", "2007-11-24", "2004-10-09")),
  incumbent =              c("Lib/Nat",    "Lib/Nat",    "Lib/Nat",    "ALP",        "ALP",        "Lib/Nat",    "Lib/Nat"),
...
expect_equal(
  results_2pp_div %>%
    ...
    pull(number_divs),
  c(147, 148, 148, rep(150, 6), rep(151, 2))
)

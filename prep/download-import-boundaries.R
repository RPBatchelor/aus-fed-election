...
shapefiles <- c(
  "https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/digital-boundary-files/CED_2021_AUST_GDA94_SHP.zip",
...
sfnames <- paste0("ced_boundaries_", c(2022, 2019, 2016, 2013, 2010))
...
div_boundaries <- bind_rows(shapes) %>%
